...
from crawlDistributeDemo.controlNode.UrlManager import UrlManager
from crawlDistributeDemo.controlNode.DataOutput import DataOutput
        ...
        while True:
            while (url_manager.has_new_url()):
                ...
                if (url_manager.old_url_size() > 2000):
                    ...
                    print('控制节点发起结束通知!')
                    # 关闭管理节点，同时存储set状态
                    url_manager.save_progress('files/new_urls.txt', url_manager.new_urls)
                    url_manager.save_progress('files/old_urls.txt', url_manager.old_urls)
                    return
